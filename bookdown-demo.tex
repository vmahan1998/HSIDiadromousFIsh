...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.1560}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.8440}}@{}}
\toprule\noalign{}
...
{\centering \includegraphics[width=0.8\linewidth]{bookdown-demo_files/figure-latex/unnamed-chunk-5-1} 
