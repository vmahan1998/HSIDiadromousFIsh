...
# Your data
data <- data.frame(
  Temperature_Range_C = c("3-11","11-17","17-22","22-28","28-29.7","29.7+",
               "0-10","10-15","15-20","20-27","27+",
               "0-8","8-10","10-12","12-16","16-18","18-20","20+"),
...
pardue_data <- data[7:11, ]
brown_data <- data[12:17, ]

#Note that range=0, which means that whiskers extend to the minimum and maximum values.
jpeg(filename="Fig01.juv_Alewife_Temp_HSI.jpeg", units="in", width=9, height=4, res=400)
...
data= matrix(c("0-0.5", "0.5-3", "3-5", "3-10", "10-20", "20+",
               "NA",
               "0-MLT","MLT-3","3-10","10-20","20-50","50-100"), ncol=1, byrow=TRUE)

## create columns for table
HSI <- c(0.0,1.0,1.0,1.0,0.5,0.0,
         "NA",
         0.5,1.0,1.0,0.1,0.0,0.0)
data <-cbind(data, HSI)
